      ...
      <div className="animate-fade-up">
        <header className="py-20 border-b border-border relative">
          <div className="flex gap-2 mb-8 flex-wrap items-center">
            <Link
              to="/"
              className="p-1.5 rounded-full border border-border text-ink-dim hover:text-lingua hover:border-lingua-dim transition-colors cursor-pointer flex items-center justify-center mr-2"
              aria-label="Home"
            >
              <Home size={14} />
            </Link>
